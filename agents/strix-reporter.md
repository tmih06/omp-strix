...
tools: [bash, think, get_plan, load_skill, create_note, list_notes, get_note, record_coverage, list_coverage, get_threat_model, create_vulnerability_report, create_dependency_report, update_vulnerability_report, list_reports, get_report]
---
